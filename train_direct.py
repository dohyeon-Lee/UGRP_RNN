...
## parameters, dataset
database = data_loader(num_epochs=300, device=device) #200 
...
if MODE == 1:
    traced_script_module.save("model/ugrp_traced_model_loss1_"+str(num_epochs)+"_.pt")
elif MODE == 2:
    traced_script_module.save("model/ugrp_traced_model_loss12_"+str(num_epochs)+"_.pt")
elif MODE == 3:
    traced_script_module.save("model/ugrp_traced_model_loss123_"+str(num_epochs)+"_.pt")
